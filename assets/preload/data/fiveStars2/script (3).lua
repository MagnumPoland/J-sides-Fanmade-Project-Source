function onCreate()
	...
	makeAnimatedLuaSprite('wacky animated icon lol what the fuck not clickbait 3 am', 'icons/LittleStar', getProperty('iconP1.x'), getProperty('iconP1.y'))
	addAnimationByPrefix('wacky animated icon lol what the fuck not clickbait 3 am', 'idle', 'LittleStar Anim', 24, false)
...
function onUpdate(elapsed)
	...
	setProperty('wacky animated icon lol what the fuck not clickbait 3 am.x', getProperty('iconP1.x') - 30)
	setProperty('wacky animated icon lol what the fuck not clickbait 3 am.angle', getProperty('iconP1.angle'))
	setProperty('wacky animated icon lol what the fuck not clickbait 3 am.y', getProperty('iconP1.y') - 50)
	setProperty('wacky animated icon lol what the fuck not clickbait 3 am.scale.x', getProperty('iconP1.scale.x') - 0)
	setProperty('wacky animated icon lol what the fuck not clickbait 3 am.scale.y', getProperty('iconP1.scale.y') - 0)
