...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		switch(easterEgg.toUpperCase())
		{
			...
			case 'UGHFINE':
				PlayState.SONG = Song.loadFromJson("ugh-j-hard", "ugh-j");
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 3:
					#if PSYCH_WATERMARKS
					createCoolText(['J-side fanmade by'], 15);
					#else
				...
				case 4:
					#if PSYCH_WATERMARKS
					addMoreText('Pickle', 15);
					addMoreText('Kizz', 15);
					addMoreText('Magnum', 15);
					addMoreText('Zzoverzin', 15);
					addMoreText('and Boy Fuende', 15);
					#end
				// credTextShit.text += '\npresent...';
				...
				case 15:
					addMoreText('Demo'); //kutas kozła forever <3
